...
Route::middleware(['auth'])->group(function () {
    ...
    Route::livewire('/domain', 'pages::domain.index');
    Route::livewire('/domain/add', 'pages::domain.add');
    Route::livewire('/domain/expired', 'pages::domain.expired');
    Route::livewire('/domain/email', 'pages::domain.email');
    Route::livewire('/domain/{id}', 'pages::domain.edit');
    Route::livewire('/tools/backup', 'pages::tools.backup')->name('tools.backup');

    Route::get('/tools/backup/download', function () {
